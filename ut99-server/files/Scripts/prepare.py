...
def initial_setup():
    ...
    set_config_value(utIniFileServer, 'Botpack.DeathMatchPlus', 'MinPlayers', '8')
    set_config_value(utIniFileServer, 'Botpack.CTFGame', 'MinPlayers', '16')
    set_config_value(utIniFileServer, 'Botpack.DeathMatchPlus', 'InitialBots', '8')
    set_config_value(utIniFileServer, 'Botpack.CTFGame', 'InitialBots', '16')
